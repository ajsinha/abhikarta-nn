...
class TCNModel(TimeSeriesModel):
    ...
    Uses dilated causal convolutions for very long-range dependencies with
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        default_config = {
            'input_size': 1,
            'output_size': 1,
            'num_channels': [64, 64, 64],  # Hidden layers
            'kernel_size': 3,
            'dropout': 0.2,
            'learning_rate': 0.001,
            'epochs': 100,
    ...
    def fit(self, X: pd.DataFrame, y: pd.DataFrame, **kwargs) -> 'TCNModel':
        """Fit the TCN model."""
